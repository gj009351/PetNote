...
import com.duke.library.base.BaseListActivity;
import com.duke.library.interfaces.AdapterCallBack;
import com.duke.library.interfaces.OnBottomDragListener;
import com.duke.library.model.Entry;
import com.duke.library.ui.GridAdapter;
...
public class DemoListActivity extends BaseListActivity<Entry<String, String>, GridView, GridAdapter>
	...
	public void getListAsync(int page) {
		showProgressDialog(com.duke.library.R.string.loading);
	...
	public void initEvent() {//必须在onCreate方法内调用
		...
		//如果adapter类型是com.duke.library.base.BaseAdapter，这两句就不用写了
