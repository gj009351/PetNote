...
import com.duke.library.util.thread.pool.ThreadPoolProxyFactory;
...
public class DemoThreadPoolActivity extends BaseActivity implements View.OnClickListener {
    ...
    * */
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btnDemoThreadPoolDefault) {
            showShortToast("请求中");
            initDefaultPool();
        } else if (id == R.id.btnDemoThreadPoolCache) {
            showShortToast("请求中");
            initCachePool();
        } else if (id == R.id.btnDemoThreadPoolSingle) {
            showShortToast("请求中");
            initSinglePool();
        }
