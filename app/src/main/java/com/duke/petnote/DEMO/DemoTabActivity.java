...
import com.duke.library.base.BaseTabActivity;
...
public class  DemoTabActivity extends BaseTabActivity implements OnClickListener, OnBottomDragListener {
	...
	public void initView() {//必须在onCreate方法内调用
		...
		//示例代码<<<<<<<<
		addTopRightButton(newTopRightImageView(context, com.duke.library.R.drawable.add_small)).setOnClickListener(new OnClickListener() {
