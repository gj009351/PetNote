...
package com.duke.petnote.manager;

import org.json.JSONObject;

import com.duke.petnote.activity.UserActivity;
import com.duke.petnote.interfaces.OnHttpResponseListener;
...
, com.duke.library.interfaces.OnHttpResponseListener {
	...
	/**com.duke.petnote.manager.HttpManager.OnHttpResponseListener的回调方法，这里转用listener处理
	 */
	@Override
