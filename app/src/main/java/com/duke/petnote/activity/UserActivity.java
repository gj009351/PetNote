...
import com.duke.petnote.util.MenuUtil;
import com.duke.petnote.view.UserView;
import com.duke.library.base.BaseActivity;
import com.duke.library.base.BaseModel;
import com.duke.library.base.BaseView.OnDataChangedListener;
import com.duke.library.interfaces.OnBottomDragListener;
import com.duke.library.interfaces.OnHttpResponseListener;
import com.duke.library.manager.CacheManager;
import com.duke.library.ui.BottomMenuView;
import com.duke.library.ui.BottomMenuView.OnBottomMenuItemClickListener;
import com.duke.library.ui.BottomMenuWindow;
import com.duke.library.ui.EditTextInfoActivity;
import com.duke.library.ui.TextClearSuit;
import com.duke.library.util.CommonUtil;
import com.duke.library.util.JSON;
import com.duke.library.util.Log;
...
, OnBottomMenuItemClickListener, OnHttpResponseListener {
	...
	public void onHttpResponse(int requestCode, String resultJson, Exception e) {
		...
		if (BaseModel.isCorrect(user) == false && e != null) {
			showShortToast(com.duke.library.R.string.get_failed);
		} else {
			setUser(user);
		}
	}
