...
import com.duke.library.base.BaseView;
...
public class UserView extends BaseView<User> implements OnClickListener {
	...
	public void bindView(User data_){
		...
		tvUserViewSex.setBackgroundResource(data.getSex() == User.SEX_FEMALE
				? com.duke.library.R.drawable.circle_pink : com.duke.library.R.drawable.circle_blue);
		tvUserViewSex.setText(data.getSex() == User.SEX_FEMALE ?  "女" : "男");
		tvUserViewSex.setTextColor(getColor(data.getSex() == User.SEX_FEMALE ? com.duke.library.R.color.pink : com.duke.library.R.color.blue));
