...
import com.duke.library.R;
import com.duke.library.interfaces.AdapterCallBack;
import com.duke.library.interfaces.CacheCallBack;
import com.duke.library.interfaces.OnStopLoadListener;
...
public abstract class BaseRecyclerActivity<T, VH extends ViewHolder, A extends Adapter<VH>>
	...
	public void setAdapter(A adapter) {
		if (adapter instanceof BaseAdapter) {
			((com.duke.library.base.BaseAdapter) adapter).setOnItemClickListener(this);
			((com.duke.library.base.BaseAdapter) adapter).setOnItemLongClickListener(this);
		}
