...
import com.duke.library.base.BaseBottomWindow;
import com.duke.library.util.CommonUtil;
import com.duke.library.util.ContactUtil;
import com.duke.library.util.EditTextUtil;
...
public class EditTextInfoWindow extends BaseBottomWindow implements OnClickListener {
	...
	public static Intent createIntent(Context context, String key, String value) {
		return createIntent(context, key, value, "com.duke.library");
	}
	/**
	 * @param context
	 * @param key
	...
	public static Intent createIntent(Context context, int type, String key, String value) {
		return createIntent(context, type, key, value, "com.duke.library");
	}
	/**
	 * @param context
	 * @param type
